...
/* Line 189 of yacc.c  */
#line 118 "drizzled/execute/parser.cc"
...
/* Line 264 of yacc.c  */
#line 169 "drizzled/execute/parser.cc"
...
/* Line 1455 of yacc.c  */
#line 100 "drizzled/execute/parser.yy"
    {   
                       query.append( std::string((yyvsp[(1) - (1)].string).str, (yyvsp[(1) - (1)].string).length));
                       query.push_back(' ');
                   }
    break;
...
/* Line 1455 of yacc.c  */
#line 106 "drizzled/execute/parser.yy"
    {
                         query.append(std::string((yyvsp[(2) - (2)].string).str, (yyvsp[(2) - (2)].string).length));
                         query.push_back(' ');
                       }
    break;
...
/* Line 1455 of yacc.c  */
#line 1379 "drizzled/execute/parser.cc"
      default: break;
    }
...
/* Line 1675 of yacc.c  */
#line 113 "drizzled/execute/parser.yy"
